...
class TelegramRepositoryImpl implements TelegramRepository {
    ...
    public async sendMessage(message: SendMessageParam): Promise<Message | Failure> {
        return await this.apiMessageRemoteDatasource.sendMessage(message);
    }

    public async sendPhoto(message: SendPhotoParam): Promise<Message | Failure> {
        return await this.apiMessageRemoteDatasource.sendPhoto(message);
    }

    public async sendAnimation(message: SendAnimationParam): Promise<Message | Failure> {
        return await this.apiMessageRemoteDatasource.sendAnimation(message);
    }

    public async sendVideo(message: SendVideoParam): Promise<Message | Failure> {
        return await this.apiMessageRemoteDatasource.sendVideo(message);
    }

    public async editMessageText(message: EditMessageTextParam): Promise<Message | Failure> {
        return await this.apiMessageRemoteDatasource.editMessageText(message);
    }

    public async editMessageReplyMarkup(message: EditMessageReplyMarkupParam): Promise<Message | Failure> {
